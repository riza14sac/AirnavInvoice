...
// GET /api/services/[id]/pdf/receipt - Download receipt PDF from Word template
export async function GET(request: NextRequest, { params }: Params) {
    try {
        ...
        // Generate PDF from Word template with signature - only page 2 (receipt)
        ...
        const filename = `Receipt_${service.receiptNo.replace(/\./g, "_")}.pdf`;
